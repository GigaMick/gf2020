                ...
                <div class="card p-4 shadow text-center">
                    <div class="card-body">
                        ...
                        <div class="text-md-left">
                            <a href="/verify-address-by-bank" class="btn btn-hero px-5 d-inline-block">Verify by bank
                                details</a>
                        </div>
                        <h4 class="text-md-left mt-4 fw700">2. Verify by post (slower)</h4>
                        <h5 class="text-md-left mt-2">We'll send you a letter containing a PIN code. When you receive
